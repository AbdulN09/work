...
urlpatterns = [
    ...
    path('api/conversations/summaries/', views.ConversationSummaryListView.as_view(), name='conversation-summary-list'),

    path('api/upload/', views.FileUploadView.as_view(), name='file-upload'),

    path('api/files/', views.UploadedFileListView.as_view(), name='file-list'),
